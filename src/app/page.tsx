  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <Link href="/" style={{ fontSize: '1.4rem', fontWeight: 800, letterSpacing: '-0.03em', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {user ? (
            <>
              <span style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>
                Hi, <strong style={{ color: 'var(--text-primary)' }}>@{userProfile?.handle || 'user'}</strong>
              </span>
            ...
            <>
              <Link href="/login" style={{ fontSize: '0.95rem', fontWeight: 500, color: 'var(--text-secondary)' }}>
                Log In
              </Link>
              <Link href="/signup" className="btn btn-primary" style={{ padding: '8px 18px', fontSize: '0.85rem', width: 'auto' }}>
                Sign Up
              </Link>
            </>
          )}
      ...
      <main style={{
        ...
        {/* Find Profile Search Bar (Client component) */}
        ...
        <div className="glass-panel" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>demo_preview</span>
          </div>
      ...
      <footer style={{
        ...
        &copy; {new Date().getFullYear()} Bookmark Hub. Built with Next.js & Supabase.
      </footer>
    </div>
  )
}
