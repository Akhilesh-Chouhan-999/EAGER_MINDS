...
const RESERVED_HANDLES = ['api', 'login', 'signup', 'dashboard', 'favicon.ico', 'public']
...
export default async function PublicProfilePage({ params }: PageProps) {
  ...
  // Guard against reserved pages clashing
  ...
  // 1. Fetch user profile matching the handle
  ...
  // 2. Fetch only PUBLIC bookmarks of this user
